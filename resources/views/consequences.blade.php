  ...
  <main class="hoc container clear"> 
    ...
    <section id="services">
      <div class="sectiontitle">
        <h6 class="heading">Voici les conséquences du réchauffement climatique</h6>
      </div>
      <ul class="nospace group grid-3 animate__animated animate__fadeInRight">
        @for ($i = 0; $i < count($articles); $i++)
          <li class="one_third animate__animated animate__pulse">
            <article><a href="{{ 'consequenses/'.str_slug($articles[$i]->titre,'-').'-'.$articles[$i]->id }}"><i class="fas fa-question"></i></a>
              ...
              <footer><a href="{{ 'consequenses/'.str_slug($articles[$i]->titre,'-').'-'.$articles[$i]->id }}">Plus d'informations &raquo;</a></footer>
            </article>
          </li>
        @endfor
      </ul>
