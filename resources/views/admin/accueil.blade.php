  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <p style="font-weight: bold; font-size: large">Réchauffement climatique</p>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            <a class="nav-link" href="/administration/logout">
              <i class="mdi mdi-logout" style="font-weight: bold; font-size: large">Se déconnecter</i>
            ...
            <div class="col-lg-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/administrateur/causes" method="post">
                    @csrf
                  ...
                  <div class="table-responsive">
                    ...
                    @if (isset($info))
                      ...
                      <form action="/administrateur/causes/modifier" method="post">
                        @csrf
                        ...
                        <tbody>
                          @for ($i = 0; $i < count($data); $i++)
                            <tr>
                              ...
                              <td style='text-align:center'><a href="/administrateur/causes/{{str_slug($data[$i]->titre,'-')}}-{{$data[$i]->id}}/modification"><i class="mdi mdi-table-edit" style='color:orange; font-size:2em'></i></a></td>
                              <td style='text-align:center'><a href="/administrateur/causes/{{str_slug($data[$i]->titre,'-')}}-{{$data[$i]->id}}/suppression"><i class="mdi mdi-delete-forever" style='color:red; font-size:2em'></i></a></td>
                            </tr>
                          @endfor
                        </tbody>
                      </table>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Selon vous, quelles pourraient être les causes de ce réchauffement climatique?
                  </p>
                    <form action="/administrateur/causes/ajouter" method="post" enctype='multipart/form-data'>
                      @csrf
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
