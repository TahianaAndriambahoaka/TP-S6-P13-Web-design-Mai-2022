            ...
            <div class="col-lg-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/administrateur/consequences" method="post">
                    @csrf
                  ...
                  <div class="table-responsive">
                    ...
                    @if (isset($info))
                      ...
                      <form action="/administrateur/consequences/modifier" method="post">
                        @csrf
                        ...
                        <tbody>
                          @for ($i = 0; $i < count($data); $i++)
                            <tr>
                              ...
                              <td style='text-align:center'><a href="/administrateur/consequences/{{str_slug($data[$i]->titre,'-')}}-{{$data[$i]->id}}/modification"><i class="mdi mdi-table-edit" style='color:orange; font-size:2em'></i></a></td>
                              <td style='text-align:center'><a href="/administrateur/consequences/{{str_slug($data[$i]->titre,'-')}}-{{$data[$i]->id}}/suppression"><i class="mdi mdi-delete-forever" style='color:red; font-size:2em'></i></a></td>
                            </tr>
                          @endfor
                        </tbody>
                      </table>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Selon vous, quelles pourraient être les consequences de ce réchauffement climatique?
                  </p>
                    <form action="/administrateur/consequences/ajouter" method="post" enctype='multipart/form-data'>
                      @csrf
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-prepend">
